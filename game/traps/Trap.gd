...
const STATS := {
	TrapType.SNAP_TRAP:  { "damage": 1.5,  "range": 3.5, "cooldown": 1.0, "cost": 10, "color": Color(0.40, 0.40, 0.80) },
	TrapType.ZAPPER:     { "damage": 25.0, "range": 6.0, "cooldown": 2.5, "cost": 25, "color": Color(0.90, 0.85, 0.20) },
	TrapType.FOGGER:     { "damage": 15.0, "range": 4.0, "cooldown": 2.0, "cost": 20, "color": Color(0.60, 0.90, 0.60) },
	TrapType.GLUE_BOARD: { "damage": 0.0,  "range": 3.0, "cooldown": 0.0, "cost": 15, "color": Color(0.80, 0.70, 0.30) },
}
