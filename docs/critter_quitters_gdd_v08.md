...
**Version:** Draft v0.8 **Status:** Concept / Pre-production **Platform:** Mobile (iOS / Android) / Web **Art Style:** ASCII / minimalist **Reference:** Desktop Tower Defense
...
6. Every 10 waves, Arena Evolution occurs — see Section 6a.
...
**Arena Evolution** occurs every 10 waves. At each evolution:
...
Boss waves follow the same wave slot as a standard wave. Frequency TBD.
...
- **Reroll** — spend Bug Bucks to replace all 3 options with a new random selection. Reroll cost TBD.
...
| Open | Boss wave frequency — every N waves; TBD |
| Open | Store reroll cost — fixed or progressive per visit; TBD |
